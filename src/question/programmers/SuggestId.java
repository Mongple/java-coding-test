...
//        System.out.println("solution : " + solution("=.="));
     ...
     * URL : <a href="https://school.programmers.co.kr/learn/courses/30/lessons/72410"></a>
     *
     * [문제 설명]
    ...
    public static String solution(String newId) {
        ...
        if (newId.length() < 3) {
            String lastWord = newId.substring(newId.length() - 1);
            
            while (newId.length() < 3) {
                newId = newId.concat(lastWord);
            }
        }
